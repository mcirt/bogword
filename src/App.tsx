...
const BUILD_VERSION = "v6.0 · GAME-FONT OCR";
...
export default function Home() {
  ...
  return <main className="app-shell">
    <header className="topbar"><a className="brand" href="#top" aria-label="Boggle Word Finder home"><span className="brand-mark" aria-hidden="true"><i>B</i><i>O</i><i>G</i></span><span>Word Finder</span></a><div className="build-version" aria-label={`Build ${BUILD_VERSION}`}>{BUILD_VERSION}</div><p>Fast, private, and free</p></header>
